...
; call <i32 as core::ops::arith::AddAssign<&i32>>::add_assign
  call void @"_ZN66_$LT$i32$u20$as$u20$core..ops..arith..AddAssign$LT$$RF$i32$GT$$GT$10add_assign17hdcc5bd5de9a07522E"(i32* noundef align 4 dereferenceable(4) %x, i32* noundef align 4 dereferenceable(4) bitcast (<{ [4 x i8] }>* @alloc2 to i32*))
  br label %bb1
...
define internal void @"_ZN51_$LT$i32$u20$as$u20$core..ops..arith..AddAssign$GT$10add_assign17ha55f36c32ab2e72fE"(i32* noundef align 4 dereferenceable(4) %self, i32 %other) unnamed_addr #1 {
start:
...
; call core::panicking::panic
  call void @_ZN4core9panicking5panic17he5e92b81a70761b4E([0 x i8]* noundef nonnull align 1 bitcast ([28 x i8]* @str.0 to [0 x i8]*), i64 28, %"core::panic::location::Location"* noundef align 8 dereferenceable(24) bitcast (<{ i8*, [16 x i8] }>* @alloc4 to %"core::panic::location::Location"*)) #5
  unreachable
}

; <i32 as core::ops::arith::AddAssign<&i32>>::add_assign
; Function Attrs: inlinehint uwtable
define internal void @"_ZN66_$LT$i32$u20$as$u20$core..ops..arith..AddAssign$LT$$RF$i32$GT$$GT$10add_assign17hdcc5bd5de9a07522E"(i32* noundef align 4 dereferenceable(4) %self, i32* noundef align 4 dereferenceable(4) %other) unnamed_addr #1 {
start:
  %_5 = load i32, i32* %other, align 4
; call <i32 as core::ops::arith::AddAssign>::add_assign
  call void @"_ZN51_$LT$i32$u20$as$u20$core..ops..arith..AddAssign$GT$10add_assign17ha55f36c32ab2e72fE"(i32* noundef align 4 dereferenceable(4) %self, i32 %_5)
  br label %bb1
