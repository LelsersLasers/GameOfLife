        ...
        for y in 0..HEIGHT {
            ...
            for offset in offsets {
                if x as i8 + offset[0] >= 0
                    && x as i8 + offset[0] < WIDTH.try_into().unwrap()
                    && y as i8 + offset[1] >= 0
                    && y as i8 + offset[1] < HEIGHT.try_into().unwrap()
                    && cells[(x as i8 + offset[0]) as usize][(y as i8 + offset[1]) as usize].alive
                {
